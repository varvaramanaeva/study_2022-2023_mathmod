...
!["График численности информированных клиентов в модели Мальтуса для условия 1 (Julia)"](./image/graph1.png){#fig:001}

!["График численности информированных клиентов в модели Мальтуса для условия 1 (OpenModelica)$"](./image/graph1_t.png){#fig:011}


Решение для условия 2 (рис. @fig:002, @fig:022).

!["График численности информированных клиентов в модели Мальтуса для условия 2 (Julia)"](./image/graph2.png){#fig:002}

!["График численности информированных клиентов в модели Мальтуса для условия 2 (OpenModelica)$"](./image/graph2_t.png){#fig:022}

Решение для условия 3 (рис. @fig:003, @fig:033).

!["График численности информированных клиентов в модели Мальтуса для условия 3 (Julia)"](./image/graph3.png){#fig:003}

!["График численности информированных клиентов в модели Мальтуса для условия 3 (OpenModelica)$"](./image/graph3_t.png){#fig:033}
